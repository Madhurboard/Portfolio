...
export function Position() {
  return (
    <>
      <TimelineEntry title="President - GeeksforGeeks Student Chapter" timestamp="June 2024 - Present" Icon={User} tint="indigo">
        <Notes>
      ...
      <TimelineEntry title="Technical Associate - CodeChef MITSOC" timestamp="July 2023 - June 2024" Icon={User} tint="green">
        <Notes>
      ...
      <TimelineEntry title="Technical Team Member - AWS Cloud Club" timestamp="August 2023 - February 2024" Icon={User} tint="blue">
        <Notes>
